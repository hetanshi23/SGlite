...
export class StockAdjPage {
  ...
  constructor(page: Page) {
    ...
    this.formHeading         = page.getByRole('heading', { name: 'Stock Adjustment' });
    ...
    this.itemCombobox         = page.getByRole('combobox').first();
    this.quantityInput        = page.locator('input[type="number"]');
    this.reasonInput          = page.locator('input[placeholder*="Opening balance"]');
    this.saveAdjustmentButton = page.locator('button[type="submit"]').filter({ hasText: 'Save Adjustment' });
    ...
    this.saveSuccessToast   = page.locator('li[role="status"]').filter({ hasText: 'Stock adjustment saved' });
    this.deleteSuccessToast = page.locator('li[role="status"]').filter({ hasText: 'Adjustment deleted' });
  }
  ...
  async resetFormByTabSwitch() {
    ...
    await this.page.getByRole('tab', { name: 'Stock Adj.' }).click();
